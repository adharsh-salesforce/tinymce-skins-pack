...
declare const throws: (message: TestLabel, f: () => void, expected?: string | undefined) => void;
declare const throwsError: (message: TestLabel, f: () => void, expected?: string | undefined) => void;
