...
const create = (stickyFirstSession, singleTimeout, overallTimeout, testfiles, loglevel) => {
    ...
    const recordTestResult = (id, name, file, passed, time, error, skipped) => {
        const now = Date.now();
        const session = getSession(id);
