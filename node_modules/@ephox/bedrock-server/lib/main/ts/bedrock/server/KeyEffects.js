...
const scrollToAndFocus = async (driver, target) => {
    await driver.execute((element) => {
        element.scrollIntoView();
        element.focus();
    }, target);
};
const performAction = async (driver, target, actions, isW3C) => {
    var _a;
    if (isW3C) {
        ...
        const isSafari = ((_a = driver.capabilities.browserName) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === 'safari';
        ...
        return driver.elementSendKeys(target.elementId, keys);
    }
};
