...
exports.writePollExit = exports.write = exports.splitCdatas = void 0;
const XMLWriter = require("xml-writer");
const fs = require("fs");
const Attempt_1 = require("./Attempt");
const outputTime = (runnerTime) => {
...
exports.splitCdatas = splitCdatas;
const write = (settings, data) => {
    ...
    results.forEach((res) => {
        ...
        if (res.passed !== true) {
            if (res.skipped) {
                ...
                const cdatas = (0, exports.splitCdatas)((_b = (_a = res.error) === null || _a === void 0 ? void 0 : _a.text) !== null && _b !== void 0 ? _b : '');
    ...
    if (failed.length > 0) {
        return Attempt_1.Attempt.failed(['Some tests failed. See {' + reportFile + '} for details.']);
    }
    else {
        return Attempt_1.Attempt.passed(results);
    }
};
exports.write = write;
const writePollExit = async (settings, results) => {
    try {
        (0, exports.write)(settings, results);
    }
    catch (err) {
...
exports.writePollExit = writePollExit;
