...
const checkErrors = function (label, expected, definitions, settings) {
    (0, mocha_1.it)(label, function () {
        const actual = Validation.scan(definitions, settings);
        (0, AttemptUtils_1.assertErrors)(expected, actual);
    });
};
const checkResult = function (label, expected, definitions, settings) {
    (0, mocha_1.it)(label, function () {
        const actual = Validation.scan(definitions, settings);
        (0, AttemptUtils_1.assertResult)(expected, actual);
    });
};
(0, mocha_1.describe)('Validation', () => {
    ...
    checkResult('Testing a directory -> glob search for directories', {
        other: [
            'src/test/resources/html/screen.html',
            'src/test/resources/routes.json',
            'src/test/resources/test.file1',
