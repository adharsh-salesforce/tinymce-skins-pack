...
export declare const enum RunnableState {
    NotRun = "notrun",
    Passed = "passed",
    Skipped = "skipped",
    Failed = "failed"
}
declare type SyncFn = (this: Context, done: (err?: TestLabel | TestError) => void) => void;
declare type AsyncFn = (this: Context) => PromiseLike<any>;
