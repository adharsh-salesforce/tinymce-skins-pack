...
const escapeComments = (str) => str.replace(/<!--/, '&lt;!--').replace(/-->/, '--&gt;');
...
const convert = (pages) => pages.map((page) => {
    ...
    page[1] = Object.assign(Object.assign({}, page[1]), { content: tmp });
    return page;
});
exports.convert = convert;
//# sourceMappingURL=antora.converter.js.map